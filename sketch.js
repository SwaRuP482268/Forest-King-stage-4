...
function setup() {
  ...
  jack.velocityX=(4 + frameCount/1000)
...
if(gameState===1){
  ...
  textSize(25);
  fill("yellow");
  text("Deaths :"+Deaths,width/4,height/4)
...
function Tree(){
  if(frameCount % 200 === 0 ){
    ...
    tree.velocityX=-(4 + frameCount/1000);
...
function Animals1(){
  if(frameCount % 500===0){
      ...
      animals1.velocityX=-(4 + frameCount/1000)
...
function Animals2(){
  if(frameCount % 100===0){
    ...
    animals2.velocityX=-(4 + frameCount/1000)
